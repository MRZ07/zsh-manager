...
#
# ZSH_MANAGER_CONFIG_DIR  — directory containing your modules/, preload_configs/,
#                            secrets/, and zsh-manager.config.sh.
#                            Defaults to the directory of the file sourcing this
#                            script (i.e. the personal config dir).
#
# ZSH_MANAGER_PROFILES    — array of profile names to load from modules/profiles/.
